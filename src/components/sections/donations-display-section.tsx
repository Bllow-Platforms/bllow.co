...
import { NotificationBanner, NotificationCard } from "../modules/notification-card";
    ...
    <div className="p-12 container mx-auto">
      <div>
        ...
        <DefaultTypography variant="p">
          Provide your audience with a simple way to show their appreciation.
        </DefaultTypography>
      </div>
    ...
    <div className="flex gap-6  flex-col md:flex-row py-6 items-center">
      ...
      <div className="bg-indigo-600 relative justify-center items-center flex p-6 h-[725px] w-full md:w-1/2 rounded-3xl  text-white">
        <div className="w-[80%] mx-auto">
          <h2 className="text-4xl max-w-[400px]">
          ...
          <div className="bg-white relative flex-col flex h-[500px] p-6 rounded-2xl mt-4 text-gray-900">
            <div className="">
              ...
              <div className="flex p-3 rounded-2xl bg-[#F3F2FF] items-center gap-3 mt-3">
                <span className="text-xl">💖 x</span>
                <div className="flex gap-3 ">
                  {[1, 2, 5, 7, 10, 20].map((num) => (
                    <button
                      key={num}
                      className="w-8 cursor-pointer text-xs h-8 rounded-full border border-indigo-400 text-indigo-400 font-semibold"
                    >
                      {num}
                    </button>
                  ))}
      ...
      <div className="grid gap-6 w-full  md:w-1/2">
        <div className="bg-yellow-400 w-full h-[350px] p-12 rounded-3xl text-gray-900 flex items-center">
           ...
           <NotificationCard className="relative" icon={<Heart color="#fff" size={30} />} text="10,392,9023 hearts" />
           <NotificationCard className="relative" icon={<Heart color="#fff" size={30} />} text="TheFullstackMechanic sent 10 Hearts" />

           <DefaultTypography className="text-1xl max-w-[350px] text-white">
           With just a few taps, your fans can contribute (send hearts) and leave a message.
           </DefaultTypography>
           </div>
        </div>

        <div className="bg-[#3E3E3E] flex gap-3 flex-col justify-center w-full p-12 h-[350px] rounded-3xl text-white">
            <NotificationBanner icon={<Gift />}

                  text="I enjoy and love what you do......" name={"Courtney Henry"} role={"Software Developer"} message={"I enjoy and love what you do......"} supports={"1,0982"} />
